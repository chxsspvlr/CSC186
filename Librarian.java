...
public class Librarian extends User {
     ...
     public boolean authenticateStaff() {
        ...
        do {
            if (getUserID().equals(userID1[i]) &&
                password.equals(password2[i])) {
                System.out.println ("=====================================");
                System.out.println ("Welcome Back, " +getName()+ "!");
                System.out.println("Staff : " + staffID + " authenticated successfully.");
                System.out.println("Role : LIBRARIAN");
                System.out.println ("=====================================");
                return true;
            }
            i++;
        } while (i < staffID2.length);
    ...
    public void displayBookCatalogue() {
        if (authenticateStaff()) {
             ...
             System.out.println ("=====================================");
             Book bk = new Book ();
             bk.displaySearchMenu();
        } 
        else {
            System.out.println("Access denied. Cannot display catalogue.");
        }
    }
